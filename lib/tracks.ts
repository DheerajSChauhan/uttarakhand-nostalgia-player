...
export const PLAYLISTS: Playlist[] = [
  ...
  {
    id: "nostalgia-radio",
    name: "Devbhoomi Nostalgia Radio",
    tagline: "Live mountain playlist streaming along NH-309 curves",
    description: "Timeless nostalgic melodies, scenic mountain reverie, and soulful Himalayan airs.",
    source: "youtube-playlist",
